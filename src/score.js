class Score{
  ...
  static calculateScore(rensa, piece, color){
    ...
    let scale = Score.rensaBonus[rensa] + Score.lieceBonus[piece] + Score.colorBonus[color];
    if(scale === 0){
      scale = 1;
    }
...
Score.rensaBounus = [0, 8, 16, 32, 64, 96, 128, 160, 192, 224, 256, 288, 320, 352, 384, 416, 448, 480, 512, 544, 576, 608, 640, 672];
